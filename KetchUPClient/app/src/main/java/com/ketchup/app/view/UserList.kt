...
class UserList {
    companion object{
        val userList = listOf<UserData>(
            ...
            UserData("Tommy", "Le gustan los fifos","https://store.playstation.com/store/api/chihiro/00_09_000/container/ID/en/99/HP9000-BCAS20270_00-UALOUSTOMMY00000/0/image?_version=00_09_000&platform=chihiro&bg_color=000000&opacity=100&w=720&h=720"),
            UserData("Altair", "Yo que se no se arabe","https://i.pinimg.com/736x/6d/65/bd/6d65bd12e22b8e6ef494db5e6d693b98--assassins-creed--the-swag.jpg"),
            UserData("Batman", "I'm batman \uD83E\uDD87","https://image.api.playstation.com/cdn/EP1018/CUSA00135_00/xS3Qo4dKqAAaTyhCUvYOhE8cRWUlwBIr.png?w=440&thumb=false"),
            UserData("Tony Stark", "Last seen: 26/04/2019 17:30","https://img.wattpad.?s=fit&w=720&h=720"),
        )
    }
}